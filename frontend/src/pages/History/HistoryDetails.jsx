    ...
    <div className="history-details-container">
      ...
      <div className="history-details-header-card">
        <div className="details-header-info">
          <h1 className="history-details-title">Safety Check Details</h1>
        ...
        <div className="details-stats-row">
          <div className="details-stat-box">
            ...
            <span className="details-stat-label">{record.medicinesCount === 1 ? 'medicine' : 'medicines'} checked</span>
          </div>

          <div className="details-stat-box">
            <span className="details-stat-number">{record.interactionsCount}</span>
            <span className="details-stat-label">{record.interactionsCount === 1 ? 'interaction' : 'interactions'} found</span>
          </div>
        </div>
      ...
      <div className="history-details-section">
        <h2 className="details-section-title">Medicines Checked</h2>
      ...
      <div className="history-details-section">
        <h2 className="details-section-title">Interactions Found</h2>
        <div className="details-card-panel">
          {record.interactions.length === 0 ? (
            <div className="details-no-interactions">
              <span className="no-int-icon" aria-hidden="true">🟢</span>
              <p className="no-int-text">All checked medicines are safe. No interactions found.</p>
            </div>
          ) : (
            <div className="details-interactions-list">
              {record.interactions.map((int) => {
                const isSevere = int.severity.toLowerCase() === 'severe';
                return (
                  <div key={int.id} className="history-details-interaction-row">
                    ...
                    <span className={`details-severity-label severity-${int.severity.toLowerCase()}`}>
