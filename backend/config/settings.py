...
# openFDA — backend only, never exposed to frontend or API responses
...
SECRET_KEY = os.environ.get(
    "DJANGO_SECRET_KEY",
    "django-insecure-dev-fallback-key-not-for-production",
)
...
# CORS Configuration
_cors_origins = os.getenv('CORS_ALLOWED_ORIGINS', 'http://localhost:5173,http://127.0.0.1:5173,https://hack-in-motion-ricr-him-1084.vercel.app')
